...
License  : AGPL-3.0 Apache-2.0 BSD-3-Clause BSD-3-Clause-Clear GPL-2.0 GPL-3.0 LGPL-2.1 OpenSSL
...
cp debian/copyright %{buildroot}/usr/share/package-licenses/compat-mariadb-soname18/debian_copyright
...
cp storage/tokudb/PerconaFT/COPYING.APACHEv2 %{buildroot}/usr/share/package-licenses/compat-mariadb-soname18/storage_tokudb_PerconaFT_COPYING.APACHEv2
...
cp win/packaging/COPYING.rtf %{buildroot}/usr/share/package-licenses/compat-mariadb-soname18/win_packaging_COPYING.rtf
pushd clr-build
%make_install
popd
